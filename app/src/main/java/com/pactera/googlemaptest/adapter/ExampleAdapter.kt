...
public class ExampleAdapter(mList: MutableList<ExampleBean>?) : BaseQuickAdapter<ExampleBean, BaseViewHolder>(
    R.layout.item_example,
    mList
) {

    override fun convert(helper: BaseViewHolder, item: ExampleBean) {
        helper.setText(R.id.tvNumber, ""+helper.layoutPosition)
